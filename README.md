...
- [x] Explain the difference between `Relational Databases` and `SQL`.
    ...
    A Relational Database is a data-management model. SQL is a language for interacting with (querying, etc.) databases.

- [x] Why do tables need a `primary key`?

    Tables need a (unique) primary key to ensure that every row is easily accessible. PKs also make it possible to join with other tables.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
    ...
    Some relational table, a kind of go-between listing foreign keys from the two tables.
